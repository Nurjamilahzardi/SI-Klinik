...
@section('container')
    ...
    <h2 style="text-align: center;" class="mt-4">Data Pasien</h2>
    <td><a href="/pasiendashboard/create" class="btn btn-dark"> <i class="fas fa-cart-plus"></i> Tambah Data</a></td>
    <table class="table table-secondary table-striped mt-2" style="text-align: center;">
        <tr>
            <th>No</th>
            <th>ID Pasien</th>
            <th>Nama Pasien</th>
        ...
        @foreach ($pasiens as $pasien)
            <tr>
                ...
                <td>{{ $pasien->alamat }}</td>
                <td>
                    <a href="/pasiendashboard/{{ $pasien->id }}/edit" class="btn btn-secondary btn-sm"><i
